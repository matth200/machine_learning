...
all: $(BIN_FOLDER)/app $(BIN_FOLDER)/app2

#app2
$(BIN_FOLDER)/app2: $(BIN_FOLDER)/main2.o $(BIN_FOLDER)/m_learning.o $(BIN_FOLDER)/mynumber.o
	$(CXX) $^ -o $@ $(LIBS)

$(BIN_FOLDER)/main2.o: main2.cpp
	$(CXX) -c $^ -o $@ $(LIBS)
...
clean-all:
	rm $(BIN_FOLDER)/*.o $(BIN_FOLDER)/app $(BIN_FOLDER)/app2
